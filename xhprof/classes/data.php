...
class Data
{
	...
	public function save(array $xhprof_data)
	{
		...
		$sth	= $this->db->prepare("INSERT INTO `requests` SET request_caller_id = 1,  `request_host_id` = :request_host_id, `request_uri_id` = :request_uri_id, `request_method_id` = :request_method_id, `https` = :https;");
